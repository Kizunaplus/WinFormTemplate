...
{
    /// <summary>
    /// FileExistCheckAttributeクラスのユニットテスト
    /// </summary>
    [TestClass]
    public class FileExistCheckAttributeTest
    {
        #region プロパティ
        /// <summary>
        /// テスト対象
        /// </summary>
        private FileExistCheckAttribute Target
        {
            get;
            set;
        }
        ...
        {
            this.Target = new FileExistCheckAttribute(true);
        }
        #endregion
        ...
        {
            this.Target = new FileExistCheckAttribute(false);
            String data = "C:\\win.ini";
            String fieldName = "test_field";
            String message = "";
            bool actual = this.Target.Valid(data, ref message, fieldName);
