...
{
    /// <summary>
    /// DecimalValueCheckAttributeクラスのユニットテスト
    /// </summary>
    [TestClass]
    public class DecimalValueCheckAttributeTest
    {
        #region プロパティ
        /// <summary>
        /// テスト対象
        /// </summary>
        private DecimalValueCheckAttribute Target
        {
            get;
            set;
        }
        ...
        {
            this.Target = new DecimalValueCheckAttribute();
        }
        #endregion
