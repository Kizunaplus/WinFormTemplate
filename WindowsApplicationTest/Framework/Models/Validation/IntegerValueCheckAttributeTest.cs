...
{
    /// <summary>
    /// IntegerValueCheckAttributeクラスのユニットテスト
    /// </summary>
    [TestClass]
    public class IntegerValueCheckAttributeTest
    {
        #region プロパティ
        /// <summary>
        /// テスト対象
        /// </summary>
        private IntegerValueCheckAttribute Target
        {
            get;
            set;
        }
        ...
        {
            this.Target = new IntegerValueCheckAttribute();
        }
        #endregion
