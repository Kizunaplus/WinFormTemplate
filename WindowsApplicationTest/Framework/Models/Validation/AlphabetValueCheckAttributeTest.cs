...
{
    /// <summary>
    /// AlphabetValueCheckAttributeクラスのユニットテスト
    /// </summary>
    [TestClass]
    public class AlphabetValueCheckAttributeTest
    {
        #region プロパティ
        /// <summary>
        /// テスト対象
        /// </summary>
        private AlphabetValueCheckAttribute Target
        {
            get;
            set;
        }
        ...
        {
            this.Target = new AlphabetValueCheckAttribute();
        }
        #endregion
